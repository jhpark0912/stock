...
**색상 값**:
```css
--primary: 173 58% 39%;           /* #14B8A6 - Teal-500 */
...
| 단계 | HSL | HEX | 용도 |
|-----|-----|-----|------|
| 50  | 173 78% 96% | #F0FDFA | 배경 (아주 연함) |
| 100 | 173 74% 91% | #CCFBF1 | 배경 (연함) |
| 200 | 173 72% 82% | #99F6E4 | 테두리 (연함) |
| 300 | 173 68% 68% | #5EEAD4 | 테두리 |
| 400 | 173 61% 53% | #2DD4BF | Hover 상태 |
| **500** | **173 58% 39%** | **#14B8A6** | **Primary (기본)** |
| 600 | 173 65% 31% | #0D9488 | Active 상태 |
| 700 | 173 70% 25% | #0F766E | 강조 |
| 800 | 173 76% 20% | #115E59 | 매우 강조 |
| 900 | 173 82% 16% | #134E4A | 다크 모드 |
