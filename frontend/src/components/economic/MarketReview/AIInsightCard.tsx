    ...
    <div className="bg-card border rounded-lg overflow-hidden">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-foreground">{getFlag()} AI 오늘의 포인트</h3>
        </div>
        ...
        <div className="p-4">
            ...
            <div className="text-center py-8 space-y-4">
              ...
              {error ? (
                <>
                  ...
                  {error.includes('API 키') || error.includes('Gemini') ? (
                    ...
                    <>
                      ...
                      <div className="space-y-2">
                        <h3 className="text-lg font-semibold text-foreground">AI 분석 실패</h3>
                ...
                <>
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg font-semibold text-foreground">AI 마감 리뷰 분석</h3>
                    <p className="text-sm text-muted-foreground max-w-md mx-auto">
                      AI가 오늘의 시장을 분석하여 핵심 포인트를 요약해 드립니다.
                    </p>
                  </div>
                  <Button onClick={onGenerate} disabled={disabled || loading} className="gap-2">
          ...
          {loading && (
            <div className="flex flex-col items-center justify-center py-8 gap-4">
              ...
              <p className="text-sm text-muted-foreground">AI가 시장을 분석하고 있습니다...</p>
            </div>
          )}
