...
export const mockUsMarketReview: MarketReviewData = {
  ...
  top_gainers: [
    ...
    { rank: 3, symbol: 'TSLA', name: 'Tesla', price: 245.8, change_percent: 5.8, volume: 85000000 },
    { rank: 4, symbol: 'META', name: 'Meta', price: 485.3, change_percent: 4.5, volume: 22000000 },
    {
      rank: 5,
      symbol: 'AMZN',
      name: 'Amazon',
  ...
  top_losers: [
    ...
    { rank: 2, symbol: 'BA', name: 'Boeing', price: 205.3, change_percent: -3.8, volume: 18500000 },
    { rank: 3, symbol: 'DIS', name: 'Disney', price: 95.2, change_percent: -3.2, volume: 15000000 },
    {
      rank: 4,
      symbol: 'XOM',
      name: 'Exxon Mobil',
...
export const mockKrAIAnalysis: MarketReviewAI = {
  summary:
    '반도체 섹터 강세 속에 KOSPI가 1% 이상 상승 마감했습니다. 외국인 자금 유입이 지속되며 대형주 중심의 상승세가 나타났습니다.',
...
export const mockUsAIAnalysis: MarketReviewAI = {
  summary:
    '기술주 강세로 나스닥이 1.2% 상승 마감했습니다. NVIDIA 실적 기대감과 AI 투자 확대가 주요 상승 요인입니다.',
